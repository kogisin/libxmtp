...
impl serde::Serialize for commit_pending_proposals_data::V1 {
        ...
        S: serde::Serializer,
    {
        ...
        if !self.proposal_hashes.is_empty() {
            struct_ser.serialize_field("proposalHashes", &self.proposal_hashes.iter().map(pbjson::private::base64::encode).collect::<Vec<_>>())?;
        }
        struct_ser.end()
    }
}
...
impl serde::Serialize for post_commit_action::Installation {
        ...
        S: serde::Serializer,
    {
        ...
        if let Some(v) = self.welcome_pointee_encryption_aead_types.as_ref() {
            struct_ser.serialize_field("welcomePointeeEncryptionAeadTypes", v)?;
        }
        struct_ser.end()
    }
}
...
impl serde::Serialize for propose_group_context_extension_data::V1 {
        ...
        S: serde::Serializer,
    {
        ...
        if !self.group_context_extension.is_empty() {
            #[allow(clippy::needless_borrow)]
            #[allow(clippy::needless_borrows_for_generic_args)]
            struct_ser.serialize_field("groupContextExtension", pbjson::private::base64::encode(&self.group_context_extension).as_str())?;
        }
        struct_ser.end()
    }
}
...
impl serde::Serialize for propose_member_update_data::V1 {
        ...
        S: serde::Serializer,
    {
        ...
        if !self.add_inbox_ids.is_empty() {
            struct_ser.serialize_field("addInboxIds", &self.add_inbox_ids.iter().map(pbjson::private::base64::encode).collect::<Vec<_>>())?;
        }
        if !self.remove_inbox_ids.is_empty() {
            struct_ser.serialize_field("removeInboxIds", &self.remove_inbox_ids.iter().map(pbjson::private::base64::encode).collect::<Vec<_>>())?;
        }
        struct_ser.end()
    }
}
...
impl serde::Serialize for PullInDeadline {
        ...
        S: serde::Serializer,
    {
        ...
        if !self.target_data_hash.is_empty() {
            #[allow(clippy::needless_borrow)]
            #[allow(clippy::needless_borrows_for_generic_args)]
            struct_ser.serialize_field("targetDataHash", pbjson::private::base64::encode(&self.target_data_hash).as_str())?;
        }
        if self.not_later_than_ns != 0 {
            #[allow(clippy::needless_borrow)]
            #[allow(clippy::needless_borrows_for_generic_args)]
            struct_ser.serialize_field("notLaterThanNs", ToString::to_string(&self.not_later_than_ns).as_str())?;
        }
        struct_ser.end()
    }
}
...
impl serde::Serialize for readd_installations_data::V1 {
        ...
        S: serde::Serializer,
    {
        ...
        if !self.readded_installations.is_empty() {
            struct_ser.serialize_field("readdedInstallations", &self.readded_installations.iter().map(pbjson::private::base64::encode).collect::<Vec<_>>())?;
        }
        struct_ser.end()
    }
}
...
impl serde::Serialize for SendSyncArchive {
        ...
        S: serde::Serializer,
    {
        ...
        if !self.sync_group_id.is_empty() {
            #[allow(clippy::needless_borrow)]
            #[allow(clippy::needless_borrows_for_generic_args)]
            struct_ser.serialize_field("syncGroupId", pbjson::private::base64::encode(&self.sync_group_id).as_str())?;
        }
        if let Some(v) = self.pin.as_ref() {
            struct_ser.serialize_field("pin", v)?;
        }
        if !self.server_url.is_empty() {
            struct_ser.serialize_field("serverUrl", &self.server_url)?;
        }
        struct_ser.end()
    }
}
        ...
        if let Some(v) = self.task.as_ref() {
            match v {
                task::Task::ProcessWelcomePointer(v) => {
                    struct_ser.serialize_field("processWelcomePointer", v)?;
                }
                task::Task::SendSyncArchive(v) => {
                    struct_ser.serialize_field("sendSyncArchive", v)?;
                }
                task::Task::ProcessPendingSelfRemove(v) => {
                    struct_ser.serialize_field("processPendingSelfRemove", v)?;
                }
                task::Task::PullInDeadline(v) => {
                    struct_ser.serialize_field("pullInDeadline", v)?;
                }
                task::Task::KpRotation(v) => {
                    struct_ser.serialize_field("kpRotation", v)?;
                }
                task::Task::KpDeletion(v) => {
                    struct_ser.serialize_field("kpDeletion", v)?;
                }
                task::Task::AddMissingInstallations(v) => {
                    struct_ser.serialize_field("addMissingInstallations", v)?;
                }
                task::Task::KpLiveness(v) => {
                    struct_ser.serialize_field("kpLiveness", v)?;
                }
            }
        }
        struct_ser.end()
...
impl serde::Serialize for update_metadata_data::V1 {
        ...
        S: serde::Serializer,
    {
        ...
        if let Some(v) = self.expected_field_value.as_ref() {
            struct_ser.serialize_field("expectedFieldValue", v)?;
        }
        struct_ser.end()
    }
}
