...
impl serde::Serialize for GetPayerInfoRequest {
        ...
        S: serde::Serializer,
    {
        ...
        if !self.payer_addresses.is_empty() {
            struct_ser.serialize_field("payerAddresses", &self.payer_addresses)?;
        }
        if self.granularity != 0 {
...
impl serde::Serialize for GetPayerInfoResponse {
        ...
        S: serde::Serializer,
    {
        ...
        if !self.payer_info.is_empty() {
            struct_ser.serialize_field("payerInfo", &self.payer_info)?;
        }
        struct_ser.end()
    }
}
...
impl serde::Serialize for get_payer_info_response::PayerInfo {
        ...
        S: serde::Serializer,
    {
        ...
        if !self.period_summaries.is_empty() {
            struct_ser.serialize_field("periodSummaries", &self.period_summaries)?;
        }
        struct_ser.end()
    }
}
...
impl serde::Serialize for get_payer_info_response::PeriodSummary {
        ...
        S: serde::Serializer,
    {
        ...
        if self.amount_spent_picodollars != 0 {
            ...
            struct_ser.serialize_field("amountSpentPicodollars", ToString::to_string(&self.amount_spent_picodollars).as_str())?;
        }
        if self.num_messages != 0 {
            #[allow(clippy::needless_borrow)]
            #[allow(clippy::needless_borrows_for_generic_args)]
            struct_ser.serialize_field("numMessages", ToString::to_string(&self.num_messages).as_str())?;
        }
        if self.period_start_unix_seconds != 0 {
            #[allow(clippy::needless_borrow)]
            #[allow(clippy::needless_borrows_for_generic_args)]
            struct_ser.serialize_field("periodStartUnixSeconds", ToString::to_string(&self.period_start_unix_seconds).as_str())?;
        }
        struct_ser.end()
    }
}
